...
import 'package:coffeeapp/views/black_gold.dart';
import 'package:coffeeapp/views/cold_brew.dart';
import 'package:coffeeapp/views/gold_brew.dart';
import 'package:coffeeapp/views/mccafe.dart';
import 'package:coffeeapp/views/nescafe.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      children: [
        ...
        Positioned(top: 35.0, left: 20.0, child: Icon(Icons.menu)),
        Positioned(top: 35.0, right: 20.0, child: Icon(Icons.shopping_bag)),
        Positioned(
